                                                          ...
                                                          <p style="text-align: center;margin:0;padding-bottom:1em">
                                                            <span style="font-family:arial,helvetica,sans-serif;">
                                                              <span style="font-size: 16px;">
                                                                <a href="${result.url}" target="_blank" class="btn btn-default" style="word-wrap:break-word;color:#0000cd;font-weight:normal;text-decoration:underline">Click to Open Vendor Panel</a>
                                                              </span>
                                                            </span>
                                                          </p>
...
exports.rejectVendorEmail = function(result,callback)
{
    const template = `<!DOCTYPE html>
    <html xmlns="http://www.w3.org/1999/xhtml">
        <head>
          <meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
          <meta name="viewport" content="width=device-width, initial-scale=1" />
          <title>${GLOBALS.APP_NAME} - Sorry!</title>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        background: linear-gradient(to right, #fff 0%, #fff 100%) !important;">
                                                          ...
                                                          <img align="center" alt="Logo" class="kmImage" src="http://35.183.149.96/logo192.png" width="100" style="border:0;height:auto;line-height:100%;outline:none;text-decoration:none;padding-bottom:0;display:inline;vertical-align:bottom;max-width:199px;" />
                                                        </td>
                                                      </tr>
                                                    </tbody>
                                                  </table>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="kmTextContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#000;font-family:Helvetica, Arial;font-size:14px;line-height:150%;text-align:left;padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                                                          ...
                                                          <p style="margin:0;padding-bottom:1em;text-align: justify;"><span style="font-size:16px;"><span style="color: rgb(0, 0, 0);"><span style="font-family: arial,helvetica,sans-serif;"></span></span></span></p>
                                                          <p style="margin:0;padding-bottom:1em"><span style="font-family:arial,helvetica,sans-serif;"><span style="font-size: 16px;">Hi <strong>${result.fname}</strong>,</span></span></p>
                                                          <p style="margin:0;padding-bottom:1em">Welcome to ${GLOBALS.APP_NAME}! Thank you for Time At ${GLOBALS.APP_NAME} Vendor community.</p>
                                                          <p style="margin:0;padding-bottom:1em">Unfortunately, We can not Approve Your Vendor Account, For Missing Information  </p>
                                                          <p style="margin:0;padding-bottom:1em">Please, Re Register With Your Details. </p>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td class="kmTextContent" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;color:#000;font-family:Helvetica, Arial;font-size:14px;line-height:150%;text-align:left;padding-top:9px;padding-bottom:9px;padding-left:18px;padding-right:18px;">
                                                          ...
                                                          <!-- Your Content As below -->
                                                          <p style="margin:0;padding-bottom:1em;text-align: justify;"><span style="font-size:16px;"><span style="color: rgb(0, 0, 0);"><span style="font-family: arial,helvetica,sans-serif;"></span></span></span></p>
                                                          <p style="margin:0;padding-bottom:1em"><span style="font-family:arial,helvetica,sans-serif;"><span style="font-size: 16px;">Hi <strong>${result.name}</strong>,</span></span></p>
                                                          <p style="margin:0;padding-bottom:1em">It seems you have forgotten your password.</p>
                                                          <p style="margin:0;padding-bottom:1em">Please click on the link below and follow the steps to change your password: </p>
